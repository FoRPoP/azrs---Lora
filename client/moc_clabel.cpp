...
#define QT_MOC_LITERAL(idx, ofs, len)                                          \
  Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                     \
      len, qptrdiff(offsetof(qt_meta_stringdata_CLabel_t, stringdata0) + ofs - \
...
void CLabel::qt_static_metacall(QObject* _o,
                                QMetaObject::Call _c,
                                int _id,
                                void** _a)
{
  ...
  else if ( _c == QMetaObject::IndexOfMethod )
  {
    ...
    {
      using _t = void (CLabel::*)();
      if ( *reinterpret_cast<_t*>(_a[1]) == static_cast<_t>(&CLabel::clicked) )
      {
        *result = 0;
        return;
      }
...
QT_INIT_METAOBJECT const QMetaObject CLabel::staticMetaObject = {
    {&QLabel::staticMetaObject, qt_meta_stringdata_CLabel.data,
