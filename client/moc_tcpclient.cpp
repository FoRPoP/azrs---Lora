...
#define QT_MOC_LITERAL(idx, ofs, len)                                       \
  Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                  \
      len, qptrdiff(offsetof(qt_meta_stringdata_TcpClient_t, stringdata0) + \
...
static const uint qt_meta_data_TcpClient[] = {
    ...
    1, 1, 64, 2, 0x06 /* Public */, 3, 1, 67, 2, 0x06 /* Public */, 4, 0, 70, 2,
    0x06 /* Public */, 5, 0, 71, 2, 0x06 /* Public */,

    // slots: name, argc, parameters, tag, flags
    6, 1, 72, 2, 0x0a /* Public */, 7, 0, 75, 2, 0x08 /* Private */, 8, 0, 76,
    2, 0x08 /* Private */, 9, 0, 77, 2, 0x08 /* Private */, 10, 0, 78, 2,
    0x08 /* Private */, 11, 0, 79, 2, 0x08 /* Private */,

    // signals: parameters
    QMetaType::Void, QMetaType::QString, 2, QMetaType::Void, QMetaType::QString,
    2, QMetaType::Void, QMetaType::Void,

    // slots: parameters
    QMetaType::Void, QMetaType::QString, 2, QMetaType::Void, QMetaType::Void,
    QMetaType::Void, QMetaType::Void, QMetaType::Void,

    0  // eod
};

void TcpClient::qt_static_metacall(QObject* _o,
                                   QMetaObject::Call _c,
                                   int _id,
                                   void** _a)
{
  if ( _c == QMetaObject::InvokeMetaMethod )
  {
    ...
    {
      case 0:
        _t->connection((*reinterpret_cast<QString(*)>(_a[1])));
        break;
      case 1:
        _t->start((*reinterpret_cast<QString(*)>(_a[1])));
        break;
      case 2:
        _t->notReady();
        break;
      case 3:
        ...
        break;
      case 4:
        _t->sendMessage((*reinterpret_cast<QString(*)>(_a[1])));
        break;
      case 5:
        _t->readMessage();
        break;
      case 6:
        _t->on_connect_clicked();
        break;
      case 7:
        _t->connectedToServer();
        break;
      case 8:
        _t->on_disconnect_clicked();
        break;
      case 9:
        _t->disconnectedByServer();
        break;
      default:;
    }
  }
  else if ( _c == QMetaObject::IndexOfMethod )
  {
    int* result = reinterpret_cast<int*>(_a[0]);
    {
      ...
      if ( *reinterpret_cast<_t*>(_a[1]) ==
           static_cast<_t>(&TcpClient::connection) )
      {
        *result = 0;
        return;
      }
    ...
    }
    {
      ...
      if ( *reinterpret_cast<_t*>(_a[1]) ==
           static_cast<_t>(&TcpClient::notReady) )
      {
        *result = 2;
        return;
      }
    }
    {
      using _t = void (TcpClient::*)();
      if ( *reinterpret_cast<_t*>(_a[1]) ==
           static_cast<_t>(&TcpClient::showFullMessage) )
      {
        *result = 3;
        return;
      }
