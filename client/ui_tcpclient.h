...
class Ui_TcpClient
{
 public:
  ...
  {
    TcpClient->setWindowTitle(
        QApplication::translate("TcpClient", "TcpClient", nullptr));
    groupBox->setTitle(
        QApplication::translate("TcpClient", "Server configuration", nullptr));
    ...
    disconnect->setText(
        QApplication::translate("TcpClient", "disconnect", nullptr));
  }  // retranslateUi
};
